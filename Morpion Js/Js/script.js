...
function replay(){
    ...
    for(let i = 1; i <=9; i++){
        ...
        boxReset.classList.remove("boxO")
    }
...
function boxHover(){
    ...
    if(turn == 0){
        box1.classList.add("boxO")
        box2.classList.add("boxO")
        box3.classList.add("boxO")
        box4.classList.add("boxO")
        box5.classList.add("boxO")
        box6.classList.add("boxO")
        box7.classList.add("boxO")
        box8.classList.add("boxO")
        box9.classList.add("boxO")
    }
    else{
        box1.classList.remove("boxO")
        box2.classList.remove("boxO")
        box3.classList.remove("boxO")
        box4.classList.remove("boxO")
        box5.classList.remove("boxO")
        box6.classList.remove("boxO")
        box7.classList.remove("boxO")
        box8.classList.remove("boxO")
        box9.classList.remove("boxO")
    }
}
